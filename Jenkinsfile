        ...
        stage('Get Envs Variables') {
            steps {
                script {
                    ...
                    echo "Code Commiter: ${envParameters.committerName}, Code Commiter Email: ${envParameters.committerEmail}, Commit Hash: ${envParameters.GIT_COMMIT}, Git URL: ${envParameters.GIT_URL}"
                }
            }
        }
